...
{
    echo "Configuring aws cli using aws cofigure  for tooling account"
...
EOF
  ...
  #ret_code=$?
   ...
   # exit $ret_code
  # fi
  aws iam attach-role-policy --profile aws_sample_central_tooling --policy-arn arn:aws:iam::aws:policy/AWSCodeCommitPowerUser --role-name $infra_build_role
  aws iam attach-role-policy --profile aws_sample_central_tooling --policy-arn arn:aws:iam::aws:policy/AWSCodePipeline_FullAccess --role-name $infra_build_role
  aws iam attach-role-policy --profile aws_sample_central_tooling --policy-arn arn:aws:iam::aws:policy/AmazonS3FullAccess --role-name $infra_build_role
  aws iam attach-role-policy --profile aws_sample_central_tooling --policy-arn arn:aws:iam::aws:policy/AWSCodeBuildAdminAccess --role-name $infra_build_role
